...
> **About this file:** This is the **standard OpenTelemetry Astronomy Shop** README (upstream demo: goals, vendor table, quick start). It lives under `docs/otel-readme.md` so the **[root README](../README.md)** can focus on **this fork’s Bazel migration** and documentation map.
