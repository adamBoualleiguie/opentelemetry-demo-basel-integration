...
| R5 | Contributor onboarding friction | Fewer PRs | Med | Docs (`docs/bazel/milestones/`, `docs/planification/4-bazel-dev-environment-ubuntu.md`), thin Make wrappers | _TBD_ |
